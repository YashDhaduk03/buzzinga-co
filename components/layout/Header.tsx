    ...
    >
      <div className="mx-auto flex h-full w-full max-w-[1920px] items-center justify-between px-4 min-[810px]:px-6 xl:px-10">
        ...
        <Link
          ...
          className="header-cta hidden h-full items-center whitespace-nowrap text-[16px] font-[700] leading-[1.5] tracking-[-0.02em] text-[#262D30] !underline !decoration-[2px] underline-offset-[3px] min-[810px]:flex"
        >
          Contact Us
        </Link>
